...
# Add Chips and Betting System.
# If the player runs out of chips, display a game over message and provide an option to restart with a default amount of chips.
