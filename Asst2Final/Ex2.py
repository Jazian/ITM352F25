...
# # Generated by Copilot with prompt "Create a function to prompt user to export dataframe to CSV"
# Creates a function that is referenced through other functions to export any dataframe to CSV
...
# Copied from Lab:Assignment 2 Workshop
def get_user_selection(options, prompt): 
    ...
    # Generated by Copilot with prompt "Fix index error" which validates the input by converting to int and checking range while getting rid of empty strings and commas
    try:
...
# Generated by Copilot with prompt "Create a function to generate a custom pivot table" utilising pasted content required from Lab:Assignment 2 Workshop question 5
